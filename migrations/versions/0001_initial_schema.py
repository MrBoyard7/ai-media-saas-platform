...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("owner", "admin", "member", "billing", name="member_role"),
            nullable=False,
    ...
    op.create_index(
        "ix_credit_transactions_wallet_created", "credit_transactions", ["wallet_id", "created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "plan", sa.Enum("free", "starter", "pro", "enterprise", name="subscription_plan"), nullable=False
        ),
        sa.Column(
            "status",
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column(
            "plan", sa.Enum("free", "starter", "pro", "enterprise", name="plan_feature_plan"), nullable=False
        ),
        sa.Column(
            "feature_id",
            postgresql.UUID(as_uuid=True),
